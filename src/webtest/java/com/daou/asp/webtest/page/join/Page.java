package com.daou.asp.webtest.page.join;
...
public class Page extends com.daou.asp.webtest.page.Page {
	...
	public com.daou.asp.webtest.page.join.auth.Page click_agreementBtn_pageMove() {
	    this.button_agreementBtn.click();
	    return new com.daou.asp.webtest.page.join.auth.Page(driver);
	}
}
