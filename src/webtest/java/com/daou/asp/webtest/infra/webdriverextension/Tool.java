package com.daou.asp.webtest.infra.webdriverextension;
...
import com.daou.asp.webtest.infra.Infra;
...
public class Tool implements Infra {
	...
	public static boolean checkIf_exist(By by) {
		boolean exist = true;
...
//		System.out.println("length : " + (classFullName.split("\\.")).length);
		...
		for(int i=5; i<splitPackageName.length-1; i++){
